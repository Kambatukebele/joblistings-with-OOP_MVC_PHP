	...
	<html lang="zxx" class="no-js">
	  ...
	  <body>
	    ...
	    <header id="header" id="home">
	      <div class="container">
	        <div class="row align-items-center justify-content-between d-flex">
	          <div id="logo">
	            <a href="index.html"><img src="<?=ROOT_ASSETS?>theme/img/logo.png" alt="" title="" /></a>
	          </div>
	          ...
	          <div class="active-popular-post-carusel">
	            <div class="single-popular-post d-flex flex-row">
	              ...
	              <div class="details">
	                ...
	                <h6>Los Angeles</h6>
	                <p>
	                  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod temporinc ididunt ut labore
	            ...
	            <div class="single-popular-post d-flex flex-row">
	              <div class="thumb">
	                <img src="<?=ROOT_ASSETS?>theme/img/p2.png" alt="">
	                <a class="btns text-uppercase" href="#">view job post</a>
	              </div>
	              <div class="details">
	                <a href="#">
	            ...
	            <div class="single-popular-post d-flex flex-row">
	              <div class="thumb">
	                <img src="<?=ROOT_ASSETS?>theme/img/p1.png" alt="">
	                <a class="btns text-uppercase" href="#">view job post</a>
	              </div>
	              <div class="details">
	                <a href="#">
	      ...
	      <div class="container">
	        ...
	        <div class="row">
	          <div class="col-lg-2 col-md-4 col-sm-6">
	            <div class="single-fcat">
	              <a href="category.html">
	                <img src="<?=ROOT_ASSETS?>theme/img/o1.png" alt="">
	              </a>
	              <p>Accounting</p>
	            </div>
	          </div>
	          <div class="col-lg-2 col-md-4 col-sm-6">
	            <div class="single-fcat">
	              <a href="category.html">
	                <img src="<?=ROOT_ASSETS?>theme/img/o2.png" alt="">
	              </a>
	              <p>Development</p>
	            </div>
	          </div>
	          <div class="col-lg-2 col-md-4 col-sm-6">
	            <div class="single-fcat">
	              <a href="category.html">
	                <img src="<?=ROOT_ASSETS?>theme/img/o3.png" alt="">
	              </a>
	              <p>Technology</p>
	            </div>
	          </div>
	          <div class="col-lg-2 col-md-4 col-sm-6">
	            <div class="single-fcat">
	              <a href="category.html">
	                <img src="<?=ROOT_ASSETS?>theme/img/o4.png" alt="">
	              </a>
	              <p>Media & News</p>
	            </div>
	          </div>
	          <div class="col-lg-2 col-md-4 col-sm-6">
	            <div class="single-fcat">
	              <a href="category.html">
	                <img src="<?=ROOT_ASSETS?>theme/img/o5.png" alt="">
	              </a>
	              <p>Medical</p>
	            </div>
	          </div>
	          <div class="col-lg-2 col-md-4 col-sm-6">
	            <div class="single-fcat">
	              <a href="category.html">
	                <img src="<?=ROOT_ASSETS?>theme/img/o6.png" alt="">
	              </a>
	              <p>Goverment</p>
	            </div>
	          </div>
	        ...
	        <div class="row justify-content-center d-flex">
	          <div class="col-lg-8 post-list">
	            ...
	            <div class="single-post d-flex flex-row">
	              <div class="thumb">
	                <img src="<?=ROOT_ASSETS?>theme/img/post.png" alt="">
	                <ul class="tags">
	                  <li>
	                    <a href="#">Art</a>
	                  </li>
	          ...
	          <div class="col-lg-3  col-md-12">
	            <div class="single-footer-widget mail-chimp">
	              ...
	              <ul class="instafeed d-flex flex-wrap">
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i1.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i2.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i3.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i4.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i5.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i6.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i7.jpg" alt=""></li>
	                <li><img src="<?=ROOT_ASSETS?>theme/img/i8.jpg" alt=""></li>
	              </ul>
	            </div>
	          </div>
	        </div>
	    ...
	    <script src="<?=ROOT_ASSETS?>theme/js/vendor/jquery-2.2.4.min.js"></script>
	    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"
	      integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous">
	    </script>
	    <script src="<?=ROOT_ASSETS?>theme/js/vendor/bootstrap.min.js"></script>
	    <script type="text/javascript"
	      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/easing.min.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/hoverIntent.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/superfish.min.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/jquery.ajaxchimp.min.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/jquery.magnific-popup.min.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/owl.carousel.min.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/jquery.sticky.js"></script>
	    <script src="<?=ROOT_ASSETS?>theme/js/jquery.nice-select.min.js"></script>
